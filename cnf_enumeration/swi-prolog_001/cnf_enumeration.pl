...
% public referred to
cnf_enumeration_config_001( RULECOUNT, VARCOUNT, CNF) :- true % see cnf_enumeration_A380518.pl
...
cnf_enumeration_config_002( RULECOUNT, VARCOUNT, CNF) :- true % see cnf_enumeration_A380610.pl
